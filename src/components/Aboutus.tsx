  ...
  return (
    <>
      ...
      <div id="about_content" className="flex flex-col gap-10 pb-10">
        <img src={img1} className="p-10 animate-on-scroll"></img>
        <div id="text-cotnent" className="flex flex-col gap-3 p-3">
          <div className="font-bold animate-on-scroll">
            The Signature menu includes pizzas that are rooted in the American
            culinary tradition.
          </div>
          <div className="text-xs animate-on-scroll">
        ...
        <img src={img2} className="p-10 animate-on-scroll"></img>
        <div id="text-cotnent" className="flex flex-col gap-3 p-3">
          <div className="font-bold animate-on-scroll">
      ...
      >
        ...
        <div
          className="flex flex-col items-center justify-center w-42 h-42 rounded-full gap-3 text-white animate-on-scroll"
