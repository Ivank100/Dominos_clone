    ...
    <div className="flex items-center justify-center p-4 pb-16 text-center">
      <div className="flex flex-col justify-center items-center gap-6 p-2">
        ...
        <div className="flex border">
          ...
          ></input>
          <button disabled={!isphoneValid} className={`px-4 py-2 text-sm whitespace-nowrap rounded-lg m-1 ${isphoneValid ? "text-white" : "bg-gray-200 text-gray-400"}`} style={isphoneValid ? { backgroundColor: "#006491" } : {}}>Confirm OTP</button>
        </div>
        <div className="flex w-full justify-end"><span>e.g. 08X-XXX-XXXX</span></div>
        <button
